...
- (void)buildData{
    BOOL enableRemoteNotification = NO;
    if (IOS8) {
        enableRemoteNotification = [UIApplication sharedApplication].currentUserNotificationSettings.types == UIUserNotificationTypeNone;
    }else{
        enableRemoteNotification = [UIApplication sharedApplication].enabledRemoteNotificationTypes == UIRemoteNotificationTypeNone;
    }
